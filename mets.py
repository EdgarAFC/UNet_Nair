...
def main():
    ...
    #     filename=simu_name+".npy"
        ...
        #testing model wang
        dir_model_WANG = '/mnt/nfs/efernandez/generated_samples/WANG/L1_LOSS_udiff/gen_att2/'
    ...
    save_dir='/mnt/nfs/efernandez/generated_samples/mets/test_TESIS_28_6_v1'
    ...
    # name of csv file
    filename = '/mnt/nfs/efernandez/generated_samples/mets/test_TESIS_28_6_v1.csv'
